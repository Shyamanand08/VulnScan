    ...
    def Hyd(self,ip):
        ...
        while var==1:
            ...
            if input_for_list==1:
                ...
                print("")
                protocol=input("[+] Enter the service running from your end ssh or ftp > ")
               
                ip_version=input("[+] Enter version of ip (4 for ipv4 or 6 for ipv6) > ")
                os.system("hydra -L "+username_list+" -P "+password_list+" "+ip+ " "+protocol+" -t "+ip_version+" -V -F")
