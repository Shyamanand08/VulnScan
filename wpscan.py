...
class Wpscan():
    def wpsc(self,ip):
        ...
        while var==1:
            print(f"[+] 1 for {ip}")
            print("[+] 2 URL of your WorddPress")
            print("[+] 3 Exit")
            ...
            if input_for_wpscan==1:
                ...
                while var1==1
                    ...
                    if input_for_list==1:
                        ...
                        print("[+] This is your currentWorking Directory and your Dictionary you created > ")
                        print(os.system("pwd;find *.txt"))
                        print("")
                        os.system("sudo wpscan -L "+username_list+"-P "+password_list+" --url http://"+ip)
                ...
                if input_for_wpscan1=="http":
                    ...
                    os.system("sudo wpscan -L "+username_list+"-P "+password_list+" --url http://"+input_wp_url)
                else:
                    os.system("sudo wpscan -L "+username_list+"-P "+password_list+" --url https://"+input_wp_url)
